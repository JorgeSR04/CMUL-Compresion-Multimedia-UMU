...
% Calcula la frecuencia con la que aparecen los enteros [0,255] en una secuencia
...
% Salidas:
%   FREQ: Vector columna de 256 enteros con la distribucion de frecuencias 
%       en la secuencia x, indexada por los enteros 0 a 255 
%       Hay un offset: FREQ(1) es frecuencia de entero 0
